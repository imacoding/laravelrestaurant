                ...
                <div class="card gradient-1">
                    <a href="{{URL::to('/admin/driver')}}">
                        <div class="card-body">
                            ...
                            <div class="d-inline-block">
                                <h2 class="text-white">{{isset($driver) ? count($driver) : ''}}</h2>
                            </div>
                ...
                <div class="card gradient-1">
                    <a href="{{URL::to('/admin/pincode')}}">
                        <div class="card-body">
                            ...
                            <div class="d-inline-block">
                                <h2 class="text-white">{{isset($getpincode) ? count($getpincode) : ''}}</h2>
                            </div>
                ...
                <div class="card gradient-2">
                    <a href="{{URL::to('/admin/orders')}}">
                        <div class="card-body">
                            ...
                            <div class="d-inline-block">
                                <h2 class="text-white">{{ isset($order_tax) ? Auth::user()->currency . number_format($order_tax, 2) : '' }}
</h2>
                            </div>
