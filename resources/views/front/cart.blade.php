                ...
                <div class="col-lg-8">
                    ...
                    <div class="cart-box">
                        <div class="cart-pro-img">
                            <img src="{{ asset('images/item/' . $cart['itemimage']->image) }}" alt="">
        ...
        geocodeAddress(address)
            .then(function(addressComponents) {
                if (addressComponents) {
                    ...
                    document.getElementById("postal_code").value = addressComponents.postalCode;
                    document.getElementById("city").value = addressComponents.city;
                    document.getElementById("country").value = addressComponents.country;
                    document.getElementById('lat').value = addressComponents.lat;
                    document.getElementById('lang').value = addressComponents.lng;
                }
            })
