        ...
        else
        {
            ...
            if ($request->hasFile('file')) {
                ...
                foreach($files as $file){
                    ...
                    $file->move(public_path('images/item'), $image);
            ...
            if ($request->hasFile('ingredients')) {
                ...
                foreach($ingredients as $file){
                  ...
                  $file->move(public_path('images/ingredients'), $image);
        ...
        else
        {
            ...
            if(isset($request->image)){
                if($request->hasFile('image')){
                    ...
                    $request->image->move(public_path('images/item'), $image);;
                    $itemimage->image=$image;
        ...
        else
        {
            ...
            if(isset($request->image)){
                if($request->hasFile('image')){
                  ...
                  $request->image->move(public_path('images/ingredients'), $image);
                    $itemimage->image=$image;
